  ...
  return (
    <div className="flex-1 pb-24 md:pb-8 px-4 md:px-10 flex flex-col gap-6 w-full max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/pos"
          className="h-12 bg-primary text-primary-foreground rounded-xl font-semibold text-sm px-5 flex items-center gap-2 hover:opacity-90 transition-colors active:scale-95"
        >
